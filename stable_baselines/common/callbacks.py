...
class TensorboardCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        # Log episode length value
        if self.locals['done']:
            episode_length = self.locals['episode_length']
            summary = tf.Summary(value=[tf.Summary.Value(tag='episode_length', simple_value=episode_length)])
